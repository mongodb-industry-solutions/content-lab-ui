    ...
    <>
      ...
      <Modal open={open} setOpen={setOpen} className={styles.modal}>
        <div className={styles.modalContent}>
          <Tabs aria-label="info wizard tabs" onChange={handleTabChange} selected={selected}>
                  ...
                  <div key={sectionIndex} className={styles.section}>
                    {section.heading && <H3 className={styles.modalH3}>{section.heading}</H3>}
                    {
                      section.body && section.isHTML === true
                        ? <div className={styles.htmlRender} dangerouslySetInnerHTML={{ __html: section.body }} />
