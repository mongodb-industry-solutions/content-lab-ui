/**
 * Proxy route for fetching user profile from search backend
 * GET /api/content/profile?userId=...
 */
...
export async function GET(request) {
  try {
    ...
    const url = `${backendUrl}/api/content/profile${queryString ? '?' + queryString : ''}`;
